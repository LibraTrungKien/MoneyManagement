...
class AddNewExpendAdapter(val data : List<Category>) : RecyclerView.Adapter<AddNewExpendAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ItemAddNewCategoryBinding) : RecyclerView.ViewHolder(binding.root){
